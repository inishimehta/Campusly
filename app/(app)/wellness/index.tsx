      ...
      <ScrollView ref={scrollRef} contentContainerStyle={styles.toolsScroll} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <Text style={styles.desc}>
            Wake up feeling refreshed by sleeping in 90-minute cycles. What time do you need to wake up?
          </Text>

          <Pressable style={styles.timePickerBtn} onPress={() => setShowTimePicker(true)}>
            <Text style={styles.timePickerText}>
              {wakeDate.toLocaleTimeString([], { hour: "numeric", minute: "2-digit" })}
            </Text>
            <Ionicons name="time-outline" size={20} color="#6B7280" />
          </Pressable>

          <View style={styles.bedtimeRow}>
            <View style={styles.bedtimeBox}>
              <Text style={styles.bedtimeSub}>9 Hours</Text>
              <Text style={styles.bedtimeTime}>{bedtimes[0]}</Text>
            </View>
            <View style={styles.bedtimeBox}>
              <Text style={styles.bedtimeSub}>7.5 Hours</Text>
              <Text style={styles.bedtimeTime}>{bedtimes[1]}</Text>
            </View>
            <View style={styles.bedtimeBox}>
              <Text style={styles.bedtimeSub}>6 Hours</Text>
              <Text style={styles.bedtimeTime}>{bedtimes[2]}</Text>
            </View>
          </View>
          ...
          {showTimePicker && Platform.OS === "ios" && (
            <DateTimePicker
              ...
              style={{ height: 120, alignSelf: "center", marginTop: 10 }}
            />
          )}
        </View>
        ...
        >
          ...
          <Text style={styles.desc}>
            Got too much on your mind? Type it out, then clear it away. (This is private and not saved anywhere).
          </Text>
          <TextInput
          ...
          />
          <Pressable
            style={[styles.dumpBtn, !dumpText && { opacity: 0.5 }]}
            onPress={() => setDumpText("")}
            disabled={!dumpText}
          >
    ...
    return (
      <View style={{ gap: 14 }}>
        <View style={styles.advisorHeaderRow}>
          ...
          <Pressable
            style={styles.myApptIconBtn}
            onPress={() => router.push("/(app)/wellness/my-appointments")}
          >
